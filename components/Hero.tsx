  ...
  return (
    <section className="hero" id="top">
      <div className="badge">
        ...
        Free to start &mdash; install in 60 seconds
      </div>
      <h1 className="hero-title">Your AI<br /><em>senior reviewer</em><br />never sleeps</h1>
      <p className="hero-sub">BugLens reviews every pull request before your team does. Catches bugs, vulnerabilities, and style violations &mdash; reviewed against your own codebase for context.</p>
      ...
      <div className="hero-trust">
        ...
        <span>No CI changes</span>
        <span className="hero-trust-sep">&middot;</span>
        <span>No config files</span>
        <span className="hero-trust-sep">&middot;</span>
